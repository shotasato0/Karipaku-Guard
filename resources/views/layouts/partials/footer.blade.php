<footer class="text-gray-600 body-font">
    <div class="bg-gray-100">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row items-center">
            <p class="text-gray-500 text-sm text-center">© 2023 Karipaku Guard —</p>
            <a href="https://twitter.com/shoprogramming" rel="noopener noreferrer" class="text-gray-600 ml-3"
                target="_blank">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-5"
                    viewBox="0 0 24 24">
                    <path
            ...
            <a href="https://github.com/shotasato0" rel="noopener noreferrer" class="text-gray-600 ml-3"
                target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-github w-4 h-5"
                    viewBox="0 0 16 16">
                    <path
