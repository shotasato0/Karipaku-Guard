    ...
    <body class="antialiased">
        <div class="container mx-auto p-6 lg:p-20 text-black-800 dark:text-white">
            ...
            <section class="mb-10">
                ...
                <p>借りパクガードは、個人間の貸し借りを管理するためのアプリです。貸し主、借りた物、借りた日、返却期限を記録し、管理することができます。</p>
            </section>
            ...
            <section class="mb-10">
                ...
                <ol class="list-decimal ml-5">
                    <li>リスト表示 - 借りた物の一覧を見ることができます。</li>
                    <li>信頼度表示 - 返却期限に応じて信頼度がビジュアル化されます。</li>
                    <li>編集・削除 - 借り物の情報を編集、または削除することができます。</li>
            ...
            <section class="mb-10">
                ...
                <dl class="ml-5">
                    ...
                    <dd class="mb-5">A: はい、アプリを使用するにはユーザー登録が必要です。</dd>
                    <!-- 他の質問と回答を追加 -->
                </dl>
            </section>
        </div>
