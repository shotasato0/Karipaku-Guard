<x-main :minHeightClass="'min-h-screen'">
    ...
    <div class="container mx-auto p-6 lg:p-20 text-black-800 dark:text-white">
        ...
        <p class="text-lg">借りパクガードにアクセスいただきありがとうございます。開発者のショウ<a href="https://twitter.com/shoprogramming"
            ...
            <br>ちなみにこの要素は、某有名恋愛シュミレーションゲームからヒントを得た（というよりほぼ丸パ◯リの）アイディアで、本家では攻略ヒロインに嫌われていくと爆弾が点灯し、
            MAXまで嫌われると爆弾が爆発して攻略不能になってしまうという要素でした。つまり、爆弾アイコンを使いたいがために、「貸した物を管理するアプリ」ではなく「借りた物を管理するアプリ」として開発することにしたのです。適当な理由ですみません。<br>
