...
<div class="container mx-auto px-4">
    <div class="flex flex-wrap justify-center">
        ...
        <div class="w-full lg:w-1/2 px-4">
            ...
            <p>ここにアプリの説明文を入れます。</p>
            <div class="mt-6">
                <a href="{{ route('login') }}" class="bg-blue-500 text-white font-bold py-3 px-6 rounded-lg mr-4">ログイン</a>
                <a href="{{ route('register') }}" class="bg-green-500 text-white font-bold py-3 px-6 rounded-lg">新規登録</a>
            </div>
        </div>
